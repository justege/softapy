...
export const QuestionaireInChat = (props: QuestionaireInChatProps) => {
  ...
  const calculateHeight = useMemo(() => {
    if (
      popup?.popupChatHistoryPercentage &&
      popup?.popupCTAPercentage &&
      chatGPTs.length > 0
    ) {
      return `${
        parseInt(popup?.popupChatHistoryPercentage) +
        parseInt(popup?.popupCTAPercentage)
      }%`;
    }
      ...
      <MotionBox padding={3}>
        ...
        {question?.answers.some((e) => e.answerHasInputField) && (
          <ChakraButton
            ...
            textColor={
              popup?.popupQuestionarySubmitButtonTextColor ?? undefined
            }
            backgroundColor={
              popup?.popupQuestionarySubmitButtonColor ?? undefined
            }
            borderColor={popup?.popupQuestionarySubmitBorderColor ?? undefined}
            borderWidth={
              popup?.popupQuestionarySubmitHasBorder ? "thin" : undefined
            }
          >
                ...
                <ChakraBox key={index}>
                  <Flex justifyContent="flex-end">
                    <MotionBox
                      ...
                      borderWidth="1px"
                      borderColor={
                        popup?.popupChatHistoryInputFocusBorderColor ??
                        undefined
                      }
                      boxShadow="md"
                      textColor={
                        popup?.popupChatHistoryInputTextColor ?? undefined
                      }
                      backgroundColor={
                        popup?.popupChatHistoryInputBoxColor ?? undefined
                      }
                      position="relative"
                      _after={{
                        content: '""',
                    ...
                    >
                      {pastChatGPTInput.length > 0
                        ? input
                        : popup?.popupExampleInputChatGPT}
                    </MotionBox>
                  </Flex>
                  {pastChatGPTOutput[index] && (
                    <Flex justifyContent="flex-start">
                      ...
                      <MotionBox
                        ...
                        borderWidth="1px"
                        borderColor={
                          popup?.popupChatHistoryOutputFocusBorderColor ??
                          undefined
                        }
                        boxShadow="md"
                        textColor={
                          popup?.popupChatHistoryOutputTextColor ?? undefined
                        }
                        backgroundColor={
                          popup?.popupChatHistoryOutputBoxColor ?? undefined
                        }
                        position="relative"
                        overflow="hidden"
                        _after={{
                        ...
                        textAlign={"left"}
                      >
                        <Text>{pastChatGPTOutput[index]}</Text>
                      </MotionBox>
                    </Flex>
                  )}
                </ChakraBox>
              ...
              <ChakraBox>
                <Flex justifyContent="flex-start">
                  ...
                  <MotionBox
                    ...
                    borderWidth="1px"
                    borderColor={
                      popup?.popupChatHistoryOutputFocusBorderColor ?? undefined
                    }
                    boxShadow="md"
                    textColor={
                      popup?.popupChatHistoryOutputTextColor ?? undefined
                      ...
                      <WrapItem w={"full"}>
                        ...
                        >
                          <ChakraButton
                            ...
                            onClick={() =>
                              clickAnswer(answer.id, answer.text_for_chatgpt)
                            }
                            href={
